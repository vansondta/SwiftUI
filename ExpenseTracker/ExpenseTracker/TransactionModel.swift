...
extension Category {
    ...
    static let billsAndUnitilities = Category(id: 2, name: "Bills & Unitilities", icon: .file_invoice_dollar)
    ...
    static let foofAndDining = Category(id: 5, name: "Food & Dining", icon: .hamburger)
